...
```
#### Example
To understand how the program works, you can run `SMT` on the example dataset that is provided in the project root. More datasets can be found [here](https://drive.google.com/drive/folders/1B8kG4Vbaam6fHHMdymA5BfIWHEWSnpZn?usp=sharing).
