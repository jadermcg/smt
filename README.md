...
```
#### Example
To understand how the program works, you can run `SMT` on the example dataset that is provided in the project root. More datasets can be found here: [datasets]()
